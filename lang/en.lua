...
ZO_CreateStringId("SI_TF_SETTING_GROUPLEADERALPHA", "Opacity of the Group Leader icon")
ZO_CreateStringId("SI_TF_SETTING_GROUPLEADERALPHA_TOOLTIP", "0 = Hidden\nChanges the transparency of the group leader icon.")
